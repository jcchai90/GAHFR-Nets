...
def plot_cam(
    ...
    with cam_algorithm(model=model,
        ...
        for file_name in glob.glob(image_path):
            ...
            file_path = os.path.join(cam_path, os.path.split(file_name)[-1])
...
def concat_images(
    ...
    base_dir = os.path.split(image_path)[0]
    output_dir = os.path.join(base_dir, "combine_cam")
    os.makedirs(output_dir, exist_ok=True)
    rel_path = os.path.join(output_dir, "combine_cam.jpg")
